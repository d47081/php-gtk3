...
extern "C"
{
    ...
    PHPCPP_EXPORT void *get_module()
    {
        ...
        gtkapplicationwindow.method<&GtkApplicationWindow_::get_show_menubar>("get_show_menubar");
        ...
        gtktreeviewcolumn.method<&GtkTreeViewColumn_::set_cell_data_func>("set_cell_data_func");
        ...
        gtklabel.method<&GtkLabel_::select_region>("select_region");
...
GValue phpgtk_get_gvalue(Php::Value phpgtk_value, GType type_column)
{
    ...
    case G_TYPE_ULONG:
    {
        // Cast
        int64_t b = (int64_t)phpgtk_value;
        g_value_init(&gtk_value, G_TYPE_INT64);
        g_value_set_int64(&gtk_value, b);
